...
# # dist: 
# # 	tar -czf lab2a-40205638.tar.gz lab2_add.c lab2_list.c SortedList.c SortedList.h\
# # 	 lab2_add.csv lab2_list.csv lab2_add-1.png lab2_add-2.png lab2_add-3.png lab2_add-4.png\
# # 	  lab2_add-5.png lab2_list-1.png lab2_list-2.png lab2_list-3.png lab2_list-4.png Makefile README\
# # 	  lab2_list.gp lab2_add.gp 

# dist: lab2_add lib2_list lab2_add.csv lab2_list.csv
# 	tar -czf lab2a-40205638.tar.gz Makefile README *.c *.h *.csv *.png *.gp
...
IMG = lab2_add-1.png lab2_add-2.png lab2_add-3.png lab2_add-4.png lab2_add-5.png lab2_list-1.png lab2_list-2.png lab2_list-3.png lab2_list-4.png


all: lab2_add lab2_list

# add:
# 	gcc $(CFLAGS) lab2_add.c -o lab2_add -lpthread

# list:
# 	gcc $(CFLAGS) lab2_list.c SortedList.c -o lab2_list -lpthread
...
dist: lab2_add lab2_list $(CSV) $(IMG)
	tar -zcvf lab2a-40205638.tar.gz README Makefile $(SRC) $(CSV) $(IMG) lab2_add.gp lab2_list.gp

clobber:
	rm -f lab2_list lab2_add lab2a-40205638.tar.gz $(IMG) $(CSV)